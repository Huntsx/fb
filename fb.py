...
def loginSC():
	...
	if username =="black" and password =="hunt":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/100051023651488')
				menu()
